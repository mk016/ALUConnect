...
export default function ChatSystem({ initiallyOpen = false }: ChatSystemProps) {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button 
          className={`rounded-full shadow-lg h-14 w-14 ${isOpen ? 'bg-red-500 hover:bg-red-600' : ''}`} 
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-50 w-full sm:w-96 md:w-[450px] h-[600px] bg-background rounded-xl shadow-xl overflow-hidden border border-border glass"
          >
